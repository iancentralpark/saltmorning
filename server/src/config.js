...
module.exports = {
  ...
  LUCKY_DRAW_TRANSFERS_SHEET: 'Lucky_Draw_Transfers',
  ...
  LUCKY_STUDENT_SPIN_DAILY_LIMIT: 2,
  STAMP_BOARD_SHEET: 'Stamp_Board',
  STAMPS_PER_DOLLAR: 5,
  STAMPS_PER_COLUMN_MAX: 100,
  ENGLISH_BUDDY_HISTORY_SHEET: 'English_Buddy_History',
  ENGLISH_BUDDY_HISTORY_DAYS: 7,
  ENGLISH_BUDDY_HISTORY_MAX: 200,
