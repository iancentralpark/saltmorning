...
window.SaltI18n = (function () {
  ...
  const dict = {
    ...
    ko: {
      ...
      'admin.page.lessons': '수업 계획',
      'admin.page.teachers': '선생님',
      'admin.page.classes': '학급',
      ...
      'admin.analytics.importHelp': '학급을 선택한 뒤 공식 성적표 PDF 또는 선명한 사진을 업로드하세요.',
      'admin.analytics.importBtn': '분석 후 가져오기',
      'admin.analytics.analyze': '분석',
      'admin.rc.help': '교장 대기열 — 제출된 성적표에 서명하고 학부모와 공유합니다.',
      'admin.vocab.title': '어휘 부스터',
      'admin.vocab.help': '솔트 모닝용 어휘 부스터 관리 콘솔입니다.',
      'admin.vocab.open': '어휘 부스터 열기',
      'parent.brand': '학부모',
      'parent.hero.child': '우리 아이',
      'parent.hero.hwPending': '건의 미완료 숙제',
      'parent.hero.reports': '개의 성적표',
      'parent.message.title': '메시지',
      'parent.message.help': '선생님 또는 학교 사무실과 대화하세요. 말풍선의 자동번역으로 한국어를 볼 수 있습니다.',
      'parent.feed.title': '새소식',
      'parent.ann.title': '공지사항',
      'parent.ann.help': '학교 사무실과 담임 선생님 메시지를 한곳에서 확인합니다.',
